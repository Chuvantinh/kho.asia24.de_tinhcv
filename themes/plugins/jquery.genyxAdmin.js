...
;(function($) {	
    ...
    $.fn.genyxAdmin = function(options) { 
        ...
        var settings = { 
            ...
            setCurrent: {
                absoluteUrl: false, //put true if use absolute path links. example https://www.host.com/dashboard instead of /dashboard
       ...
       function setCurrentNav () {
           ...
           //var subdir = settings.setCurrent.subDir
            if(domain === '') {
                ...
                if(settings.setCurrent.absoluteUrl) {
                    ...
                    var newDomain = document.location.protocol + '//' + domain + window.location.pathname;
        ...
        function widgetBox () {
            ...
            widgetClosed.each(function(index) {
               ...
               wcontent = $(this).find('div.widget-manage');
            ...
            w_minimize.on('click', function() {
                ...
                if($(this).hasClass('minimize')) {
                    ...
                    $(this).closest('div.widget-title').next('div.widget-manage').slideUp('200');
                } else {
                    $(this).removeClass('maximize').addClass('minimize');
                    $(this).closest('div.widget-title').next('div.widget-manage').slideDown('200');
                }
            }); 
        }
