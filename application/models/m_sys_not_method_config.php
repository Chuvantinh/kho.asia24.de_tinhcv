...
/**
 * Class M_sys_not_method_config
 *
 * @author chuvantinh1991@gmail.com
 */
class M_sys_not_method_config extends data_base
{
    ...
    {
        $this->_table_name          = 'sys_not_method_config';
        $this->_key_name            = 'id';
        $this->_exist_created_field = TRUE;
        $this->_exist_updated_field = TRUE;
        $this->_exist_deleted_field = FALSE;
        $this->_schema = Array(
            'id', 'method', 'description', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by'
        );
