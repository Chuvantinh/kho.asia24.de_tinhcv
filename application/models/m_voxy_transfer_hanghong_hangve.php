 ...
 */
class M_voxy_transfer_hanghong_hangve extends data_base
{
    var $vendor = array(
        '0' => '- Lựa chọn giá trị -',
        'LIL' => 'LIL',
    ...
    var $arr_status = array(
        '5' => 'Lưu tạm',
        '3' => 'Hàng trả về',//cong vao sl chưa cộng vào database
        '4' => 'Hàng hỏng',// ko cong sl, k tru von, chi tru doanh so
        '6' => 'Hàng thiếu',// //tru doanh so, tru doanh số, trừ vốn // trừ vào chỗ lieferschein
        '7' => 'Hàng chia thêm',// //cộng doanh so,cộng vốn // cộng vào chỗ lieferschein
    );
    ...
    public function setting_table()
    {
        ...
        $this->_field_table = Array(
            'm.id' => 'ID',
            'm.laixe' => 'Lái xe',
            'm.tracking_nummer' => 'Tour',
            'm.date' => 'Ngày giao hàng',
            'm.status' => 'Trạng thái',
        );
    }
    ...
    public function setting_select()
    {
        ...
        $this->db->where_in('status',array(3,4,5,6,7));
