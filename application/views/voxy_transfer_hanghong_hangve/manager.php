            ...
            <div class="widget e_widget">
                ...
                <div class="widget-manage">
                    ...
                    <div class="widget-form-search" style="display: block">
                        ...
                        <form id="i_form_filter" action="<?php echo base_url('voxy_transfer/ajax_list_data_new'); ?>" method="POST" target="_blank">
...
<!--                                        <button type="submit" class= "btn-primary btn" formaction="htmltopdf/baocao_hanghong_nhaccungcap">Hàng hỏng nhà cung cấp (PDF)</button>-->
                ...
                <script type="text/javascript" charset="utf-8">
                    ...
                    $(document).on("click", ".baocao_nhapkho_ajax", function (e) {
                        e.preventDefault();
                        var obj = $(".e_data_table");
                        //show_ajax_loading(obj);
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                console.log("Get san pham nhap kho thanh cong");
                                var url_xuathang_taikho = "<?php echo base_url(); ?>htmltopdf/baocao_nhaphang_taikho_pdf";
