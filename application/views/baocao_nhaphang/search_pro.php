...
<?php foreach ($list_products as $key => $item){ ?>
    <div class="result-search">
        <ul>
            <li  class="packung_timkiem" data-sl-kho ="<?php echo $item['inventory_quantity1'];?>" data-location ="<?php echo $item['location'];?>" data-title ="<?php echo $item['title'];?>" data-sku="<?php echo $item["sku1"]?>" data-donvi="<?php echo $item["option1"]?>" data-cat-id="<?php echo $item["cat_id"]?>" data-product-id="<?php echo $item["id_shopify"]?>" data-variant-id="<?php echo $item["variant1_id"]?>"><?php echo $item["title"]."-".$item["option1"]?></li>
            <li class="verpackung_timkiem" data-sl-kho ="<?php echo $item['inventory_quantity2'];?>" data-location ="<?php echo $item['location'];?>" data-title ="<?php echo $item['title'];?>" data-sku="<?php echo $item["sku2"]?>" data-donvi="<?php echo $item["option2"]?>" data-cat-id="<?php echo $item["cat_id"]?>" data-product-id="<?php echo $item["id_shopify"]?>" data-variant-id="<?php echo $item["variant2_id"]?>"><?php echo $item["title"]."-";?><b><?php echo $item["option2"]; ?></b></li>
        </ul>
    </div>
<?php  }
} ?>
...
<script type="text/javascript">
    ...
    $(".btn-add-all").on("click",function () {
        $.each($(".result-search ul li"), function () {
            ...
            $(".list_products_transfer").prepend(
                ...
                "<div style='width: 7%;height: auto;float: left' class='giabannew'>"+
                    "<input type='text' name='giabannew["+variant_id+"]' class='input_giabannew' style='min-width:50px;width: 50px;text-align: center;'>"+
                "</div>" +
    ...
    $(".packung_timkiem").on("click",function(e){
        ...
        $(".list_products_transfer").prepend(
            ...
            "<div style='width: 10%;height: auto;float: left' class='gianhapnew'>"+
                "<input type='text' name='gianhapnew["+variant_id+"]' class='gianhapnew' style='min-width:50px;width: 50px;text-align: center;'>"+
            "</div>" +
