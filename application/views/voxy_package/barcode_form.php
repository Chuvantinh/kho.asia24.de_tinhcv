<div class="modal-content container chuvantinh" style="width: 70%; margin: 0px auto ;    padding: 10px;">
                        ...
                        <?php } elseif ($input->rule['type'] == 'packung_karton') { ?>
                            <div class="row2 chu_row2">
                                <div class="col" style="width: 100%; float: left;">
                                    ...
                                    <label class="col-30" style="display:none;text-align: left !important;">Giá mua sỉ </label>
                                    <input type="text" style="display:none;" class="col-70"name="gia_mua_si" id="id_gia_mua_si" placeholder="Giá mua si">

                                    <label class="col-30" style="display:none;text-align: left !important;">Giá mua lẻ</label>
                                    <input type="text" style="display:none;" class="col-70" name="gia_mua_le" id="id_gia_mua_le" placeholder="giá mua lẻ">

                                    <label class="col-25" style="text-align: left !important; margin-bottom: 0px !important; for="id_barcode2">Barcode Sỉ</label>
                                    <input class="col-75" type="text" name="barcode2" id="id_barcode2" placeholder="mã barcode 9856" style="margin-bottom: 5px !important;">

                                    <label class="col-25" style="text-align: left !important; margin-bottom: 0px !important; for="id_barcode1">Barcode Lẻ</label>
                                    <input class="col-75" type="text" name="barcode1" id="id_barcode1" placeholder="mã barcode 9856" style="margin-bottom: 5px !important;">

                                    <label class="col-25" style="display:none; text-align: left !important; margin-bottom: 0px !important; for="id_sku2">SKU Si</label>
                                    ...
                                    <label class="col-25" style="text-align: left !important; margin-bottom: 0px !important; for="id_inventory_quantity2">Số lượng Sỉ</label>
                                    <input class="col-75" type="text" name="inventory_quantity2" id="id_inventory_quantity2" placeholder="số lượng tổng sau khi nhập hàng" style="margin-bottom: 5px !important;">

                                    <label class="col-25" style="text-align: left !important; margin-bottom: 0px !important; for="inventory_quantity1">Số lượng Lẻ</label>
                                    <input class="col-75" type="text" name="inventory_quantity1" id="id_inventory_quantity1" placeholder="số lượng 100" style="margin-bottom: 5px !important;">
                                ...
                                <div class="col" style="width: 100% ; float: left">
                                    ...
                                    <label class="col-25" style=" display:none; text-align: left !important; margin-bottom: 0px !important; for="id_sku1">SKU Le</label>
...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#i_location").on("click",function () {
            //$('#mySelect2 > select2-highlighted').removeClass('.select2-highlighted').trigger('change');
        });
