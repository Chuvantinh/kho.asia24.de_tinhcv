            ...
            <div class="widget e_widget">
                ...
                <div class="widget-manage">
                    ...
                    <div class="widget-form-search" style="display: block">
                        ...
                        <form id="i_form_filter" action="<?php echo base_url('voxy_hangtralai_nhacc/ajax_list_data_new'); ?>" method="POST" target="_blank">
                            ...
                            <div class="e_form_search">
                                ...
                                <div class="span12 e_form_search">
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class= "btn-danger btn" formaction="htmltopdf/baocao_hangtralai_taikho_pdf">In Báo Cáo Theo Ngày</button>
                                    </div>
                                </div>
                            </div>
                        </form>
