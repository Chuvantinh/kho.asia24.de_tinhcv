<div class="span6 resizable uniform modal-content container chuvantinh" style="width:70%;margin: 0 auto;    padding: 10px;">
    <form class="form-horizontal e_ajax_submit" action="<?php echo $save_link; ?>" enctype="multipart/form-data" method="POST" autocomplete="off">
                        ...
                        <?php } elseif ($input->rule['type'] == 'packung_karton') { ?>
                            <div class="row2 chu_row2">
                                <div class="columns_2" style="width: 50%; float: left;padding-right: 5px;">
                                    ...
                                    <?php if($this->USER->user_name == "tinhcv" || $this->USER->user_name == "long" || $this->USER->user_name == "maianh" || $this->USER->user_name == "lanasia24" || $this->USER->user_name == "giangvn"){
