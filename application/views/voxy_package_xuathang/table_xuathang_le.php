                    ...
                    <form action="minus_inventory_le" method="post" class="form_products"
                        ...
                        <div class="title">
                            ...
                            <p class="name_kho" style="text-align: center;" data-name-kho="<?php echo $name_kho; ?>"
                               data-kho="<?php echo $kho; ?>"><b>Danh sách xuất hàng Order <?php echo $order_number; ?></b></p>
                        </div>
                        <div class="products">
                            <div class="pro_th">
                                ...
                                <span style="width: 5%;float: left;text-align: center">Ngoài Kho</span>
                                ...
                                if($sorting == "category"){
                                    foreach ($all_products["result_catid"] as $catid) {//category
                                        ...
                                        if ($kho == "AKL") {
                                            ...
                                            if ($catid['cat_id'] == false) { ?>
                                                <b style="text-align: left;margin: 0; padding: 0;width: 100%;float: left;clear: left;font-weight: bold;font-size: 15px;">G00-Hàng Không Có Danh Mục</b>
                                            <?php } else { ?>
                                                <p style="text-align: left;margin: 0; padding: 0;width: 100%;float: none;clear: left;font-weight: bold;font-size: 15px;"><?php echo $this->m_voxy_category->get_cat_title($catid['cat_id']); ?></p>
                                            <?php }
                                        } ?>
                                            ...
                                            if ($catid['cat_id'] == $row["cat_id"]) {
                                                ...
                                                if ($kho == "all") { // in tat ca k phan biet
                                                    ...
                                                    if( strpos($row["title"], '#') !== false){
                                                        $data_handel_variant_id =  $row["variant_id"];
                                                        $data_handel_order_number =  $row["order_number"];
                                                        $data_handel_title =  $row["title"];
                                                        $data_handel_product_id =  $row["product_id"];
                                                    }else{
                                                        $data_handel_variant_id = "";
                                                        $data_handel_order_number = "";
                                                        $data_handel_title = "";
                                                        $data_handel_product_id = "";
                                                    }

                                                    ?>

                                                        <div class="infomation <?php echo $row["variant_id"]; ?>"
                                                             data-variant-old="<?php echo $data_handel_variant_id; ?>"
                                                             data-order-number="<?php echo $data_handel_order_number; ?>"
                                                             data-product-id-old="<?php echo $data_handel_product_id; ?>"
                                                             data-title="<?php echo $data_handel_title;?>"
                                                        ...
                                                        <div style="width: 45%;height: auto;float: left; text-align: center" class="parent-result">
                                                            <input type="text" class="title" data-search="class_search_<?php echo $row['variant_id'];?>"
                                                            ...
                                                            <div class="note" style="width:100%;float:left; text-transform: uppercase; text-align: center">
...
<!--                                                        </div>-->
                                                        ...
                                                        <div style="width: 5%;height: auto;float: left;" class="ngoai_kho">
                                                            <input type="checkbox" name="cb_ngoai_kho" value="" class="checkbox_ngoaikho">
                                                        </div>
                                                        <div style="width: 10%;height: auto;float: left;"
                                ...
                                }else{/// poit to phan tach location and category
...
<!--                                                         class="sl-daxuat">--><?php //echo $sl_daxuat; ?><!--</div>-->
                            ...
                            <?php }else{ ?>
                                <div class="thongbao" style="clear:left;text-align: center;margin-top:20px;font-size: 20px;text-transform: uppercase;"><?php echo $thongbao;?></div>
                            <?php } ?>
                        </div>
                        <?php if(!isset($thongbao)) { ?>
...
<div id="dialog" title="Thông báo" style="display: none">
    <p>Bạn phải thay đổi tất cả các sản phẩm linh tinh  => thành sản phẩm có trong kho, để có thể xuất hàng thành công !</p>
</div>
...
<script type="text/javascript">
    ...
    function show_ajax_loading_new(obj) {
        var img = obj.attr("data-loading_img");
        var loading = $("<div class='e_loading'>");
        loading.html("<img src='" + img + "' title='Loading'/>");
        //loading.classList.add('e_loading');
        loading.css({
    ...
    $(document).ready(function () {
        $("#btn_xuathang").on("click", function (e) {
            ...
            for (var i = 0; i < list_products.length ; i++){
                if(list_products[i].title.indexOf("#") == 0){
            ...
            //get list product to replace the # product again into orders
            var list_replace = [];
            $.each($(".infomation"),function(index){
                var title_old = $(this).attr("data-title");
                if(title_old.indexOf("#") == 0){
                    list_replace.push({
                        data_variant_old : $(this).attr("data-variant-old"),
                        data_product_id_old : $(this).attr("data-product-id-old"),
                        data_order_number : $(this).attr("data-order-number"),
                        data_title : $(this).attr("data-title"),
                        //get infor cho update cho nhanh
                        variant_id: $(this).children(".variant_id").text(),// san pham moi bi thay the
                        quantity: $(this).find(".quantity").val(),// san pham moi bi thay the
                    });
                }
            });

            show_ajax_loading_new(obj);
            ...
            $.each($(".quantity"), function (index) {
                ...
                ({
                    ...
                    quantity: $(this).val(),
                    nk: $(this).parent().parent().find(".checkbox_ngoaikho").is(":checked"),//nk: Abkürzung ngoaikho
            ...
            if (!isNaN(value.quantity) && value.quantity != null && value.quantity != "") {
                ...
                if ($("."+value.variant_id)) {
                    $(".pro_body").prepend(
                        ...
                        "<div class='list_result class_search_"+value.variant_id+"'></div>"+
                        ...
                        "<div style='width: 5%;height: auto;float: left' class='sl-daxuat'>" +
                            0 +
                        "</div>" +
            ...
            if (!isNaN(value.quantity) && value.quantity != null && value.quantity != "") {
                ...
                if ($("."+value.variant_id)) {
                    $(".pro_body").prepend(
                        ...
                        "<input type='text' class='title'  data-search='class_search_"+value.variant_id+"'>"+
                        "<div class='list_result class_search_"+value.variant_id+"'></div>"+
                        "<div class='note' style='width:100%;float:left; text-transform: uppercase; text-align: right'>"+
                        "<span style='width: 15%'>&nbsp;</span>"+
                        "</div>" +
                        "</div>"+
