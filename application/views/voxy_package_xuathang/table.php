...
Lọc: <input type="text" name="q" class="e_search_table" value="<?php echo $search_string; ?>" style="width: 93%;" autocomplete="off" />
        </div>
    </div>
    <div class="clear"></div>
</div>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover">
    ...
    <?php if (sizeof($record)) { ?>
        ...
        foreach ($record as $item) {
            ?>
            <tr class="gradeX <?php echo $item->status; ?>" data-id="<?php echo $item->$key_name; ?>">
                <?php
                foreach ($colum as $key => $value) { ?>
