            ...
            <div class="widget e_widget">
                ...
                <div class="widget-title">
                    ...
                    <div class="actions_content e_actions_content">
                        <a href="<?php echo base_url('voxy_kiemkho/export_product_excel'); ?>" style=""
                           class="export_product_excel btn btn-success btn-lg"> Cập nhật hệ thống </a>
                        <a href="<?php echo base_url('voxy_kiemkho/update_products_rest'); ?>" class="btn i-plus-circle-3 btn-info btn_update_products_rest" >Cập nhật Sản Phẩm không được kiểm</a>
                        <a href="<?php echo base_url('voxy_kiemkho/report_products_check'); ?>" class="btn i-plus-circle-3 btn-info btn_baocao_products_check" >Báo cáo sản phẩm kiểm</a>
...
<!--                           class="export_product_excel btn btn-success btn-lg"> Báo cáo hàng trong kho excel </a>-->
                ...
                <div class="widget-manage">
                    ...
                    <div class="widget-form-search" style="display: block">
                        ...
                        <form id="i_form_filter" action="<?php echo base_url('voxy_kiemkho/ajax_list_data_new'); ?>" method="POST" target="_blank">
                            ...
                            <div class="e_form_search">
                                ...
                                <div class="span2" style="margin-top: 5px;">
                                    <div class="form-group">
                                        <a href="<?php echo base_url('voxy_kiemkho/report_products'); ?>"
                                           class="report_products btn btn-success btn-lg"> Báo cáo cân bằng kho kì trước </a>
                                    </div>
                                </div>

                                <div class="span2" style="margin-top: 5px;">
                                    <div class="form-group">
                                        <a href="<?php echo base_url('voxy_kiemkho/report_products_theongay'); ?>"
                                           class="report_products_theongay btn btn-danger btn-lg"> Báo cáo cân bằng kho ngày</a>
                                    </div>
                                </div>

                                <div class="span2" style="margin-top: 5px;">
                                    <div class="form-group">
                                        <a href="<?php echo base_url('voxy_kiemkho/report_values'); ?>"
                                           class="report_values btn btn-success btn-lg"> Báo cáo kho theo giá trị </a>
                                    </div>
                                </div>

                                <div class="span2" style="margin-top: 5px;">
                                    <div class="form-group">
                                        <a href="<?php echo base_url('voxy_kiemkho/xuatfile_kiemkho'); ?>" style=""
                                           class="xuatfile_kiemkho btn btn-success btn-lg"> Xuất File kiểm kho </a>
                                    </div>
                                </div>
...
<!--                                            <option value="baocao_nhaphang_taikho_pdf">SP theo ngày-</option>-->
<!--                                            <option value="baocao_theo_nhaccungcap">Sp theo nhà cung cấp</option>-->
...
<!--                                        <button type="submit" class= "btn-danger btn in-bao-cao" formaction="htmltopdf/baocao_nhaphang_taikho_pdf">In Báo Cáo PDF</button>-->
<!--
...
<!--                                        <button type="submit" class= "btn-primary btn" formaction="htmltopdf/baocao_hanghong_nhaccungcap">Hàng hỏng nhà cung cấp (PDF)</button>-->
                ...
                <script type="text/javascript" charset="utf-8">
                    ...
                    var href_report_products_theongay = $('.report_products_theongay').attr('href');
                    ...
                    $('.date_for_orders').on('change', function () {
                        ...
                        if(typeof data2 != "undefined"){
                            ...
                            $('.report_products_theongay').attr('href', href_report_products_theongay + '?date1='+data1+'&date2=' + data2);
                            ...
                            $('.report_products_theongay').attr('href', href_report_products_theongay + '?date1=' + data1);
                    ...
                    $('.date_for_orders_end').on('change', function () {
                        ...
                        if(typeof data1 != "undefined"){
                            ...
                            $('.report_products_theongay').attr('href', href_report_products_theongay + '?date2=' + data2);
