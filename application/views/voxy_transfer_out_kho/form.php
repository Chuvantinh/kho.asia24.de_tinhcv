...
<!--                                                <div style='width: 10%;margin-left:5px;height: auto;float: left' class='location' data-location= '--><?php //echo $item['location'];?><!--'>--><?php //echo $item['location'];?><!--</div>-->
    ...
    <div class="import_excel">
        <form method="post" id="import_form" enctype="multipart/form-data">
            <p>
                <label>Chọn File Excel để Xuất Hàng</label>
...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $(".search_pro").on("change",function(e){
            ...
            if(request.length > 2){
                $.ajax({
                    url: "<?php echo base_url(); ?>voxy_transfer_out_kho/search_pro",
                    async: false,
                    type: "POST",
                    dataType: "json",
        ...
        $('#import_form').on('submit', function(event){
            event.preventDefault();
            $.ajax({
                url:"<?php echo base_url(); ?>voxy_transfer_out_kho/import",
                method:"POST",
                ...
                success:function(data){
                    ...
                    //console.log($data_parse.html);
                    $('.list_products_transfer').prepend($data_parse.html);
