                    ...
                    <form action="minus_inventory_le" method="post" class="form_products"
                        ...
                        <div class="products">
                            <div class="pro_th">
                                ...
                                <span style="width: 40%;float: left;text-align: center">Tên</span>
                                <span style="width: 10%;float: left;text-align: center">SL Xuất</span>
                                <span style="width: 5%;float: left;text-align: center">Chưa Xuất</span>
                                ...
                                if($sorting == "category"){
                                    foreach ($all_products["result_catid"] as $catid) {//category
                                        ...
                                        if ($kho == "AKL") {
                                            ...
                                            if ($catid['cat_id'] == false) { ?>
                                                <b style="text-align: left;margin: 0; padding: 0;width: 100%;float: left;clear: left;font-weight: bold;font-size: 15px;">Không có dữ liệu category</b>
                                            <?php } else { ?>
                                                <p style="text-align: left;margin: 0; padding: 0;width: 100%;float: none;clear: left;font-weight: bold;font-size: 15px;"><?php echo $this->m_voxy_category->get_cat_title($catid['cat_id']); ?></p>
                                            <?php }
                                        } ?>
