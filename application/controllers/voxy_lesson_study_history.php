...
/**
 * Class Voxy_lesson_study_history
 *
 * @author chuvantinh1991@gmail.com
 */
class Voxy_lesson_study_history extends manager_base
{
    ...
    public function setting_class()
    {
        $this->name = Array(
            "class"     => "voxy_lesson_study_history",
            "view"      => "voxy_lesson_study_history",
            "model"     => "m_voxy_lesson_study_history",
            "object"    => "Lịch sử học tập Lesson"
        );
    }
