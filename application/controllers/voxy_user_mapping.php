...
/**
 * Quan ly dnah sach mapping
 * Class Voxy_user_mapping
 *
 * @author chuvantinh1991@gmail.com
 */
class Voxy_user_mapping extends manager_base
{
    ...
    public function setting_class()
    {
        $this->name = Array(
            'class'     => 'voxy_user_mapping',
            'view'      => 'voxy_user_mapping',
            'model'     => 'm_voxy_user_mapping',
            'object'    => 'Voxy User Mapping'
        );
    }
    ...
    protected function _process_data_table($record)
    {
        ...
        if (is_array($record)) {
            ...
            if(isset($record->vu_date_joined) && intval($record->vu_date_joined) > 0){
                $record->vu_date_joined = date('d-m-Y', $record->vu_date_joined);
            }
        }
        return $record;
    }
